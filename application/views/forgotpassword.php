          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg">
                ...
                <h1 style="font-size: 14px; font-weight: bold;" class="h4 text-gray-900 mb-4">Forgot your password  ?</h1>
              </div>
              <form class="user" id="Login" action="<?php echo base_url('forgotpass/forgotpassword');?>" method="post">
